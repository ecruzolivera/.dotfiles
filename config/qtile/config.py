...
keys = [
    ...
    Key([mod], "j", lazy.layout.previous(), desc="Move focus previous item"),
    Key([mod], "k", lazy.layout.next(), desc="Move focus next item"),
...
group_labels = ["www", "term", "dev", "pdf", "chat", "6", "7", "8", "9"]
...
def init_widgets_list():
    widgets_list = [
        ...
        widget.TextBox(text="|", font="Ubuntu Mono", foreground=colors[1], padding=2, fontsize=14),
...
def start_once():
    ...
    subprocess.call([home + "/.config/autostart/wm-autostart.sh"])
