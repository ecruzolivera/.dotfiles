...
globalkeys = gears.table.join(
    awful.key({ modkey }, "c", function() year_calendar:toggle() end,
        { description = "show calendar", group = "awesome" }),
...
clientkeys = gears.table.join(
    ...
    awful.key({ modkey, "Control" }, "Return", function(c) c:swap(awful.client.getmaster()) end,
        { description = "move to master", group = "client" }), awful.key({ modkey }, "o", function(c)
        c:move_to_screen()
